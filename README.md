...
<p align="left">
  <a href="https://github.com/Darshan-P1408" target="_blank">
    <img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub">
  </a>
  <a href="https://linkedin.com/in/darshanpanchal110/" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
  </a>
  <a href="mailto:darshannnn99@gmail.com">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email">
  </a>
</p>
...
| mail -s "Disk Usage Alert" darshannnn99@gmail.com
```
...
```bash
mail -s "🚨 CRITICAL: High Disk Usage Detected" darshannnn99@gmail.com
```

### **Add Server Hostname to Alert**
```bash
df -h | awk -v host="$(hostname)" '$5+0 > 80 {print "Disk Alert from: " host "\nMount:", $6, "\nUsage:", $5}' \
| mail -s "Disk Alert from $(hostname)" darshannnn99@gmail.com
```

### **Add Timestamp to Alerts**
```bash
df -h | awk -v date="$(date)" '$5+0 > 80 {print "Alert Time: " date "\nDisk Alert 🚨\nMount:", $6, "\nUsage:", $5}' \
| mail -s "Disk Usage Alert - $(date)" darshannnn99@gmail.com
```
...
Add:
```
ALERT_EMAIL="darshannnn99@gmail.com"
THRESHOLD="80"
```
...
df -h | awk '$5+0 > 80 {
    ...
    print "Disk Alert 🚨\nMount:", $6, "\nUsage:", $5
}' | tee -a "$ALERT_FILE" | mail -s "Disk Usage Alert" darshannnn99@gmail.com
```
